...
import type { ChromaKey as _ChromaKey, ExternalBlob as _ExternalBlob, Filter as _Filter, Project as _Project, ProjectId as _ProjectId, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addFilter(arg0: ProjectId, arg1: Filter): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFilter(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProject(arg0: ProjectId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getProject(arg0: ProjectId): Promise<Project> {
        if (this.processError) {
            try {
                ...
                return from_candid_Project_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async setBackground(arg0: ProjectId, arg1: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setBackground(arg0, await to_candid_opt_n13(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateChromaKey(arg0: ProjectId, arg1: ChromaKey): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateChromaKey(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Project_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Project): Promise<Project> {
...
async function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        background: record_opt_to_undefined(await from_candid_opt_n10(_uploadFile, _downloadFile, value.background)),
        name: value.name,
        chromaKey: value.chromaKey
    };
}
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Project>): Promise<Array<Project>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Project_n8(_uploadFile, _downloadFile, x)));
}
